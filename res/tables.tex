...
\btab{tab:n3_t553_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        $V_{MP2/DZ}$ [kcal/mol]      & \multicolumn{3}{c}{$-29.77$}  \\
        $V_{MP2/TZ}$ [kcal/mol]      & \multicolumn{3}{c}{$-34.56$}  \\
        $V_{MP2/CBS}$ [kcal/mol]     & \multicolumn{3}{c}{$-37.70$}  \\
        \bottomrule
    \end{tabular}
...
\btab{tab:n3_t555_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        \midrule
        $V_{MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-38.87$}  \\
        $V_{MP2/TZ}$ [kcal/mol] & \multicolumn{3}{c}{$-43.36$}  \\
        \bottomrule
    \end{tabular}
...
\btab{tab:n3_t557_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        \midrule
        $V_{MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-43.58$}  \\
        \bottomrule
    \end{tabular}
...
\btab{tab:n3_t559_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        \midrule
        $V_{MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-47.07$}  \\
        \bottomrule
    \end{tabular}
...
\btab{tab:n3_t5511_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        \midrule
        $V_{MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-49.88$}  \\
        \bottomrule
    \end{tabular}
