...
\btab{tab:n3_t553_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        \midrule
        % $V_{MP2/dtZ}$ [kcal/mol]      & \multicolumn{3}{c}{$-29.77$}  \\
        $V_{MP2/DZ}$ [kcal/mol]      & \multicolumn{3}{c}{$-35.29$}  \\
        $V_{PNO-MP2/DZ}$ [kcal/mol]      & \multicolumn{3}{c}{$-34.99$}  \\
        $V_{SCS-MP2/DZ}$ [kcal/mol]      & \multicolumn{3}{c}{$-26.94$}  \\
        $V_{SCS-MP2/TZ}$ [kcal/mol]      & \multicolumn{3}{c}{$-34.56$}  \\
        $V_{SCS-MP2/QZ}$ [kcal/mol]      & \multicolumn{3}{c}{$-36.67$}  \\
        $V_{SCS-MP2/CBS}$ [kcal/mol]     & \multicolumn{3}{c}{$-37.70$}  \\
        $V_{CCSD(T)/DZ}$ [kcal/mol]  & \multicolumn{3}{c}{$-31.96$} \\
        $V_{CCSD(T)/CBS}$ [kcal/mol] & \multicolumn{3}{c}{$-39.60$} \\
        \bottomrule
    \end{tabular}
...
\btab{tab:n3_t555_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        \midrule
        % $V_{MP2/dtZ}$ [kcal/mol] & \multicolumn{3}{c}{$-38.87$}  \\
        $V_{MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-44.83$}  \\
        $V_{SCS-MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-36.06$}  \\
        $V_{SCS-MP2/TZ}$ [kcal/mol] & \multicolumn{3}{c}{$-43.36$}  \\
        $V_{SCS-MP2/CBS}$ [kcal/mol] & \multicolumn{3}{c}{$-46.39$}  \\
        $V_{CCSD(T)/DZ}$ [kcal/mol]  & \multicolumn{3}{c}{$-37.08$} \\
        $V_{CCSD(T)/CBS}$ [kcal/mol] & \multicolumn{3}{c}{$-47.42$} \\
        \bottomrule
    \end{tabular}
...
\btab{tab:n3_t557_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        \midrule
        % $V_{MP2/dtZ}$ [kcal/mol] & \multicolumn{3}{c}{$-43.58$}  \\
        $V_{MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-49.50$}  \\
        $V_{SCS-MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-40.81$}  \\
        $V_{SCS-MP2/TZ}$ [kcal/mol] & \multicolumn{3}{c}{$-47.84$}  \\
        $V_{CCSD(T)/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-41.91$}  \\
        \bottomrule
    \end{tabular}
...
\btab{tab:n3_t559_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        \midrule
        % $V_{MP2/dtZ}$ [kcal/mol] & \multicolumn{3}{c}{$-47.07$}  \\
        $V_{MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-44.31$}  \\
        \bottomrule
    \end{tabular}
...
\btab{tab:n3_t5511_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        \midrule
        % $V_{MP2/dtZ}$ [kcal/mol] & \multicolumn{3}{c}{$-49.88$}  \\
        $V_{MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-47.12$}  \\
        \bottomrule
    \end{tabular}
...
\btab{tab:n3_t5513_ILJ_eint}{
    ...
    \begin{tabular}{l rrr}
        ...
        $V_{tot}$ [kcal/mol] & $-$      & $-$      & $-$      \\
        \midrule
        $V_{MP2/DZ}$ [kcal/mol] & \multicolumn{3}{c}{$-49.16$}  \\
        \bottomrule
    \end{tabular}
    \caption{Interaction energies for N$_3^-$ confined inside a 11-CNT(5,5).}
}
