...
mp2_fit(x) = a*x / (b+x); a = -65.0; b = 3.5;
 cc_fit(x) = c*x / (d+x); c = -65.0; d = 3.5;

fit mp2_fit(x) 'n3_t55x_ri-scs-mp2_mix-cc-pvdz_eint.dat'  u 1:2 via a,b
fit  cc_fit(x) 'n3_t55x_dlpno-ccsdt_mix-cc-pvxz_eint.dat' u 1:3 via c,d

stats 'n3_t55x_ri-scs-mp2_mix-cc-pvdz_eint.dat'  u 1:2 name 'mp2'
stats 'n3_t55x_dlpno-ccsdt_mix-cc-pvxz_eint.dat' u 1:3 name 'cc'
...
plot mp2_fit(x) lc rgb 'gray' lw 3 t '', \
     ...
     'n3_t55x_dlpno-ccsdt_mix-cc-pvxz_eint.dat'  u 1:2 w p pt 8 lc rgb 'red'        lw 5 t 'DLPNO-CCSD(T)/cc-pVDZ', \
     'n3_t55x_dlpno-ccsdt_mix-cc-pvxz_eint.dat'  u 1:3 w p pt 9 lc rgb 'dark-red'   lw 5 t 'approximate DLPNO-CCSD(T)/cc-pVTZ'
